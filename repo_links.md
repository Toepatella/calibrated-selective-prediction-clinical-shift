...
| [isgibbs/DtACI](https://github.com/isgibbs/DtACI) | DtACI — dynamically-tuned ACI for abrupt drift (Gibbs & Candès, JMLR 2024, [arXiv:2208.08401](https://arxiv.org/abs/2208.08401)); `DtACI.R`, `FACI.R`, `AgACI.R`. **v1 Stage E** temporal track (long-run/amortized, complementary to RCPS) | flagship-playbook.md §5 Stage E |
